...
--Движок - mergeTree, сортировка по id операции и локальному времени, партиционирование по неделям - с понедельника по воскресенье так как mode = 1, TTL - 3 недели, если dt будет отставать больше чем на 3 недели запись будет удалена.
